...
class PartidosControllerTest < ActionController::TestCase
  ...
  test "should create partido" do
    assert_difference('Partido.count') do
      post :create, partido: { diapartido: @partido.diapartido, local: @partido.local, logolocal: @partido.logolocal, logovisitante: @partido.logovisitante, visitante: @partido.visitante }
    end
  ...
  test "should update partido" do
    put :update, id: @partido, partido: { diapartido: @partido.diapartido, local: @partido.local, logolocal: @partido.logolocal, logovisitante: @partido.logovisitante, visitante: @partido.visitante }
    assert_redirected_to partido_path(assigns(:partido))
  end
